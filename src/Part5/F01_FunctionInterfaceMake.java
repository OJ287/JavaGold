...
public class F01_FunctionInterfaceMake {
	...
	public static void main(String[] args) {
		...
		Function<String, Boolean> function3 = function1.andThen(function2);//String给先实行的f1作为参数，f1的结果给后实行的f2作为参数，f2的结果作为整体的返回值Boolean
		System.out.println(function3.apply("Java"));
		
		//composeの利用（自身.compose(after)）
		Function<String, Boolean> function4 = function2.compose(function1);//String给先实行的f1作为参数，f1的结果给后实行的f2作为参数，f2的结果作为整体的返回值Boolean
